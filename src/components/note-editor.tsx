...
export const NoteEditor = forwardRef<NoteEditorRef, NoteEditorProps>(
  (
    { note, onSave, onCancel, className = "", editorId = "note-editor" },
    ref
  ) => {
      ...
      <div className={`flex flex-col h-full min-h-0 ${className}`}>
        ...
        <div className="mb-4 flex-shrink-0">
          <Input
            ...
            className="text-lg font-semibold border-transparent border border-solid shadow-none px-0 focus:ring-0 focus:border-transparent"
            disabled={isLoading}
          />
        </div>
